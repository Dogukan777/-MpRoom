<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminOdalarinListesi.aspx.cs" Inherits="MedipolChat2.OdalarinListesi" %>
...
<body >
    <form id="form1" method="get" runat="server">
        <div class="AnasayfaGenel">
            ...
            <div class="odalar">
                <div class="odaAdi"><span class="odaisim">Odalar(<asp:Label ID="lblOdaSayisi" runat="server" Text="Label"></asp:Label>)</span></div>
                <hr class="cizgi" />
                <asp:Label ID="lblOdaSilMesaj" class="lblBanMesaj" runat="server" ></asp:Label>
                 
             <div class="btnodaDiv" id="btnOdadiv" runat="server">
